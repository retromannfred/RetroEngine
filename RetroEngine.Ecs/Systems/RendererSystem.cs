...
namespace RetroEngine.Ecs.Systems
{
    ...
    /// </summary>
    public class RendererSystem : RenderSystem
    {
        ...
        public RendererSystem(GraphicSettings graphicSettings)
        ...
        public override void Render(GameTime gameTime)
        {
            ...
            foreach (var entity in ActiveEntities)
            {
                ...
                if (lastBatch == null || lastBatch.BatchKey != batchKey)
                {
                    ...
                    lastBatch.Begin(World.AuxTransform);
                }
            ...
            {
                batch.Begin(World.AuxTransform);
                batch.End();
            }
        }
    }
